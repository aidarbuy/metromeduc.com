...

{
  ...
  teaser: 'Everyone intuitively knows what depression is. Thus, if you think you’re depressed, you probably are. Depressed mood, trouble sleeping, low energy, difficulty concentrating and suicidal thoughts. Basically, depression means feeling that life is hopeless.',
  text: [
...

{
  ...
  date: 'October 6, 2015',
  teaser: 'The tiny blood vessels in your kidneys are like little threads. The small blood vessels in the brain get thicker in order to handle the pressure. But this thickness reduces the size of the opening through which the blood can flow, leading to a stroke.',
  text: [
...

{
  ...
  teaser: 'If you have pain in one or both of your knees, there are many possible causes for it. <strong>Runner’s Knee</strong> causes pain on ascending and descending stairs. It is caused by being knock-kneed (knees too close together on standing).',
  text: [
...

{
  ...
  date: 'August 30, 2015',
  teaser: 'Often patients with nasal symptoms wonder if they have a sinus infection or allergies. Nasal allergy symptoms comprise 2 different groups. <b>Early phase symptoms:</b> sneezing, itchy eyes, itchy nose, and runny nose. <b>Late phase symptoms:</b> ​nasal congestion and postnasal drip.',
  text: [
...

{
  ...
  date: 'August 09, 2015',
  teaser: 'Patients will often be given a diagnosis of Upper Respiratory Infection, also known as a URI, when in fact what they have is a Lower Respiratory Infection. The respiratory tract consists of the lungs, the pharynx (throat), the nasal passages, the sinuses, and the middle ears. They are all connected.',
  text: [
...

{
  ...
  date: 'July 20, 2015',
  teaser: 'If a cough is due to an infection, then there are 2 common possibilities:  bronchitis and pneumonia. If the lungs are a bunch of grapes, an infection in the stems is bronchitis, and an infection in the grapes is pneumonia. Generally speaking, the way to tell the difference between bronchitis and pneumonia is:  with pneumonia you are short of breath.',
  text: [
...

{
  header: 'Meningitis',
  date: 'April 26, 2015',
  teaser: 'The most feared bacteria that causes meningitis is Neisseria meningitidis. It frequentrly colonizes the human nasal passages without causing an infection. It is unclear why disease occurs in some people and not in others. Most likely, there is a genetic predisposition.',
  text: [
