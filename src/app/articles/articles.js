export var articles = [
...

  {
    ...
    teaser: [
      'Everyone intuitively knows what depression is. Thus, if you think you’re depressed, you probably are. The diagnosis of clinical depression requires at least 3 of the following symptoms:',
      'Depressed mood, trouble sleeping, a loss of interest in usual activities, a poor self&#8209;image or sense of guilt, low energy, difficulty concentrating, poor or excessive appetite, appearing physically either low&#8209;energy or agitated, and suicidal thoughts.',
      'Basically, depression means feeling that life is hopeless, and that it’s all your fault.'
    ],
    text: [
...

  {
    ...
    date: 'October 6, 2015',
    teaser: [
      'The tiny blood vessels in your kidneys are like little threads, and will simply pop if the pressure is too high.',
      'The small blood vessels in the brain get thicker in order to handle the pressure.',
      'But this thickness reduces the size of the opening through which the blood can flow, leading to a stroke. The same thing happens with the vessels around the heart, leading to a heart attack.'
    ],
    text: [
 ...
 
  {
    ...
    teaser: [
      ...
      '<strong>Runner’s Knee</strong>, ​also known as <strong>C​hondromalacia Patellae</strong> ​and <strong>P​atello Femoral Syndrome</strong>,​ causes pain on ascending and descending stairs.',
      'It is caused by being knock-kneed (knees too close together on standing). This can be caused by having flat feet, or it may just be the way your body was made.'
    ],
    text: [
      'If you have pain in one or both of your knees, there are many possible causes for it. Here are 2 of the more common causes of knee pain:',
...

  {
    ...
    date: 'August 30, 2015',
    teaser: [
      'Often patients with nasal symptoms wonder if they have a sinus infection or allergies.</span>',
      'Nasal allergy symptoms comprise 2 different groups:',
      '<ul><li><b>Early phase symptoms:</b> sneezing, itchy eyes, itchy nose, and runny nose.</li><li><b>Late phase symptoms:</b> ​nasal congestion and postnasal drip.</li></ul>'
    ],
    text: [
...

  {
    ...
    teaser: [
      ...
      'The respiratory tract consists of the lungs, the pharynx (throat), the nasal passages, the sinuses, and the middle ears.',
