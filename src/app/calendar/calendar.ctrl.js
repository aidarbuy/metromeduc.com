...
export class CalendarController {
  constructor($scope, $compile, uiCalendarConfig, $firebaseObject) {
    ...
    $scope.events = [
      ...
      {title: 'Long Event', start: new Date(y, m, d - 3, 11, 0), end: new Date(y, m, d - 3, 17, 30)},
      {id: 999, title: 'Rdfdfepeating Event', start: new Date(y, m, d - 2, 17, 0), allDay: false},
      {id: 999,title: 'Repeating Event',start: new Date(y, m, d + 4, 17, 0), allDay: false},
    ...
    $scope.uiConfig = {
      calendar:{
        ...
        firstDay: 1,
        businessHours: {
          start: ["0.10:00:00", "5.10:00:00"], // a start time (10am)
          // end: { days:2, hours:22, minutes:59 },
          end: ["0.20:00:00", "5.17:00:00"] // an end time (8pm)
          // dow: [ 0, 3, 4, 5 ] // days of week. an array of zero-based day of week integers (0=Sunday)
        },
    ...
    this.uiConfig = {
      calendar: {
        ...
        header: {
          left: 'month basicWeek myCustomButton agendaWeek agendaDay',
          center: 'title',
          right: 'today prev,next'
        },
